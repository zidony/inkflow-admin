...
export const locales = {
  zh: {
    ...
    gravatarAlt: 'Gravatar 头像预览',
    gravatarApplied: '已使用邮箱 Gravatar 头像',
    sendingPasswordReset: '正在发送重置邮件...',
    passwordResetSent: '重置密码邮件已发送',
    forcingUserLogout: '正在退出登录...',
    userLoggedOut: '已强制退出所有登录',
    commentStatusApproved: '已审核',
    commentStatusPending: '待审核',
    commentStatusSpam: '垃圾',
    publishingCommentReply: '正在发布回复...',
    commentReplyPublished: '回复已发布',
    savingCommentDraft: '正在保存草稿...',
    commentDraftSaved: '草稿已保存',
  ...
  en: {
    ...
    gravatarAlt: 'Gravatar avatar preview',
    gravatarApplied: 'Gravatar avatar applied',
    sendingPasswordReset: 'Sending reset email...',
    passwordResetSent: 'Password reset email sent',
    forcingUserLogout: 'Signing out sessions...',
    userLoggedOut: 'All sessions signed out',
    commentStatusApproved: 'Approved',
    commentStatusPending: 'Pending',
    commentStatusSpam: 'Spam',
    publishingCommentReply: 'Publishing reply...',
    commentReplyPublished: 'Reply published',
    savingCommentDraft: 'Saving draft...',
    commentDraftSaved: 'Draft saved',
